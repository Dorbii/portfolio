...
test('agent cockpit is a read-only insight surface instead of a bot editor', () => {
  ...
  assert.ok(agentInsightSource.includes('Loadout parts'))
  ...
  assert.ok(agentInsightSource.includes('Action packet'))
  assert.ok(agentInsightSource.includes('PacketActionSummary'))
  assert.ok(agentInsightSource.includes('gameMaster?.legalActions'))
  assert.ok(agentInsightSource.includes('createBoardActionSummary'))
