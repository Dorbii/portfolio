...
- `c4-2` mixed-bench — rejected on **rock lighting 0.212**
...
- `c4-1` bare-plateau — rejected on **a gate **
- `c3-1` lush-shelf — rejected on **a gate **
- `c5-1` lush-shelf — rejected on **water continuity 2**
- `c2-1` dark-forest — rejected on **water fringe 4.05**
- `c1-1` dark-forest — rejected on **water continuity 1**
- `c6-1` coast-cliff — rejected on **a gate **
- `c0-1` lush-shelf — rejected on **a gate **
- `c6-1` coast-cliff — rejected on **a gate **
- `c0-1` lush-shelf — rejected on **rock lighting 0.217**
