...
- **Lane sequence in flight:** (1) T8d retroactive despill of S01/S10/S11/S15 — RUNNING (F23: all four measured 58–70% magenta-family edge px; the old zero-matte gates were blind and their hashes were wrongly enshrined as protected invariants); (2) T4d-r3 anchor-and-cover plate continuation — QUEUED (candidate D scale reference, five despilled sprites composited into the scaffold, S11 constrained, F22 scale gates + T7a-style drift gates; T4d-r2 evidence: C/D passed all fabric gates, failed only on oversized S11); (3) T9a canon-tile probe — QUEUED, owner-authorized (~2–3 calls): two overlapping high-res tiles of the winner, feather-stitched offline, owner judges seam + downsample fidelity; pass → author the full D05 canon pyramid, fail → anchor-and-cover + resolution-honest zoom cap.
