...
import { createTexture, linkProgram, loadImage } from "./webgl";
...
const INLAND_DETAIL_PATH =
  "/career-world/layers/water-surface/textures/ninjaone-inland-water-detail-r1.png";
const INLAND_RIVERBED_PATH =
  "/career-world/layers/water-surface/textures/ninjaone-inland-riverbed-r1.png";
const INLAND_SURFACE_PATH =
  "/career-world/layers/water-surface/textures/ninjaone-inland-water-surface-r1.png";
const INLAND_OWNERSHIP_PATH =
  "/career-world/layers/water-surface/masks/ninjaone-inland-terrain-erase-r1.png";
...
const REGION_SPAN = Object.freeze([0.25, 1 / 3] as const);
