export const WATER_ASSETS = Object.freeze({
  ...
  coastGeometry: Object.freeze({
    world:
      "/career-world/layers/water-surface/fields/coast-geometry-r1.png",
    territory:
      "/career-world/layers/water-surface/fields/coast-geometry-r1-4x.png",
  }),
  hydrology:
    "/career-world/layers/water-surface/fields/water-region-field-r1.png",
});
