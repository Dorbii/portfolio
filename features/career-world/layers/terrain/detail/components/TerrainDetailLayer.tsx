...
interface TerrainDetailLayerProps {
...
export function TerrainDetailLayer({
  camera,
  detailState,
  light,
}: TerrainDetailLayerProps) {
  ...
  return (
    <svg
      aria-hidden="true"
      className="career-world__layer career-world__environment-layer career-world__terrain-detail-layer"
