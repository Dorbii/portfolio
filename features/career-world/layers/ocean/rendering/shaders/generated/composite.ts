...
const float PHASE_LO     = -19.932788;
const float PHASE_SPAN   = 380.851536;
const float PHASE_K0     = 0.53392297;
const vec2  PHASE_DIR    = vec2(0.58479867, 0.81117848);
const float FIELD_KMAX   = 6.03943968;
...
void main()
{
    ...
    // that per-crest tone flattens to paint between events (openPaint), this_
    ...
    // mipmap erases this_ band), thresholded tight so the cells keep edges,
    ...
    // where the sea is working, which is the "dynamic and variant" half_ of
    ...
    // before this_ comment was earned.
    ...
    // resolvability exactly like breaking itself. Without this_, the shallow
    ...
    // deliberately rare, left the sea with almost no long_ drawn marks at all.
    ...
    // gets a handful of long_ continuous strokes where it is working and clean
    ...
    // travelling patch_ field decides where the wisps and lace lines are
