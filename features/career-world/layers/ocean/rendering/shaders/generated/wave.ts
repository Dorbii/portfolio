...
void main()
{
    ...
    // grating, and this_ file already wrote down why: "a narrowband sea is
    ...
    // ANGLE-FLAT, NOT ANGLE-DECAYING. The first cut of this_ fan decayed with
    ...
    // ...and this_ is the OTHER foam factory on the coast, the one that survived
    ...
    //
    // Summing a second train is not the answer either -- this_ file already
    ...
    // LINES by drawing each train's own contour and taking the union_, and the
    ...
    // and twice as directionally coherent as this_ sea and reads as water, on a
