...
export function createExternalAgentBriefMarkdown(input: ExternalAgentBriefInput): string {
  ...
  return [
    ...
    'If your Custom GPT Actions tool cannot send nested parameters, submit only the actionId; gptAct will use the selected legal action parameterExamples when available.',
    '',
