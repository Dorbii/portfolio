...
PRESETS['calm_swell'] = dict(
    ...
    spread=19.0, formSpread=1.0, specDense=1.0, swellTone=1.0, groupDepth=0.58, groupScale=0.399, groupAcross=1.5,
...
PRESETS['windy_rolling_surf'] = dict(
    ...
    harmM=(1.0, 1.78, 3.05), harmA=(1.0, 0.30, 0.12),
    spread=27.0, formSpread=1.0, specDense=1.0, swellTone=1.0, groupDepth=0.62, groupScale=0.315, groupAcross=1.9,
    groupNoise=620.0, groupIrreg=0.45,
...
PRESETS['heavy_crashing_surf'] = dict(
    ...
    spread=38.0, formSpread=1.0, specDense=1.0, swellTone=1.0, groupDepth=0.72, groupScale=0.338, groupAcross=2.2,
