...
COMMON = dict(
    ...
    # opaque white.
    foamDeep=16.0, foamDeepThr=2.6, foamVeil=0.30,
    ...
    crestLineW=3.8, crestLevel=0.40, laceLineW=3.6, laceLineGain=1.70, foamMass=0.96,
    crestLineFloor=0.30, laceLineThr=0.24, foamSolid=0.14,
...
PRESETS['calm_swell'] = dict(
    ...
    spread=19.0, groupDepth=0.58, groupScale=0.095, groupAcross=1.5,
    steep=0.54, setMix=0.50, setCycles=2.0, jitter=0.62,
    deepEnd=15.0, shallowEnd=4.0, tealDepth=17.0,
    breakGamma=0.80, whitecapSteep=0.315,
    preBreak=0.85, faceTeal=0.70, lipGain=0.64, foamErodeK=1.1,
    streakGain=0.13, faceLift=0.30, chopGlint=0.13, licTone=0.0, licMix=0.0,
    foamDeep=12.0, foamDeepThr=1.8, foamVeil=0.40,
    stokes=1.5, backwash=0.55,
    tauFresh=1.05, tauPersist=6.0,
    injBreak=15.0, injWhitecap=0.22, injShore=5.2,
    ...
    foamThrFresh=0.240, foamThrOld=0.76, exposure=0.97,
...
PRESETS['windy_rolling_surf'] = dict(
    ...
    harmM=(1.0, 1.78, 3.05), harmA=(1.0, 0.30, 0.12),
    spread=27.0, groupDepth=0.62, groupScale=0.120, groupAcross=1.9,
    steep=0.66, setMix=0.60, setCycles=3.0, jitter=0.70, ampL=1.05,
    deepEnd=23.0, shallowEnd=9.0, tealDepth=26.0,
    breakGamma=0.72, whitecapSteep=0.560,
    preBreak=1.15, faceTeal=0.88, lipGain=0.88, foamErodeK=1.6,
    streakGain=0.18, faceLift=0.34, chopGlint=0.20, licTone=0.0, licMix=0.0,
    foamDeep=16.0, foamDeepThr=3.0, foamVeil=0.30,
    stokes=2.6, backwash=1.0,
    tauFresh=1.35, tauPersist=6.4,
    injBreak=20.5, injWhitecap=0.09, injShore=7.7,
    ...
    foamThrFresh=0.235, foamThrOld=0.68, exposure=0.99,
...
PRESETS['heavy_crashing_surf'] = dict(
    ...
    spread=38.0, groupDepth=0.72, groupScale=0.140, groupAcross=2.2,
    steep=0.94, setMix=0.78, setCycles=2.0, jitter=0.78,
    deepEnd=24.0, shallowEnd=9.0, tealDepth=29.0,
    breakGamma=0.66, whitecapSteep=0.700,
    preBreak=1.40, faceTeal=1.00, lipGain=1.00, foamErodeK=1.8,
    streakGain=0.22, faceLift=0.38, chopGlint=0.24, licTone=0.0, licMix=0.0,
    foamDeep=17.0, foamDeepThr=2.7, foamVeil=0.26,
    stokes=4.2, backwash=1.9,
    tauFresh=1.30, tauPersist=5.5,
    injBreak=38.0, injWhitecap=0.08, injShore=15.0,
    ...
    foamThrFresh=0.205, foamThrOld=0.74, exposure=0.97,
