...
vec4 fieldP(vec2 s) {{
    ...
    // this water has been described as from the first day.
    //
    ...
    // the chop's 22), so the wave sees a slowly-varying direction and the
    // slowly-varying approximation the whole accumulator rests on still holds.
...
RUNTIME = {'uRes', 'uTime', 'uLoop', 'uScrollLoop', 'uDt', 'uFirst', 'uG', 'uFlatOcean', 'uBare', 'uLightDirection',
           'uOpenWaveVis', 'uSecVis', 'uChopVis', 'uBreakVis', 'uFlowScale',
