...
east, linking every settlement in Tanium as a node on the way. It enters at the WEST edge, **45% down that edge**, and leaves at the EAST edge, **52% down that edge**.
