...
**Your EAST edge, from its north end, exactly as the island's art delivers it** (41% of it is the island's sea):
- **0-53%: the island's GROUND** — continue it exactly as it arrives for 15-40 m and end it at the shore.
- **53-56%: a watercourse** about 3 m wide — meet it at the seam and let it reach the sea.
- **56-60%: the island's GROUND** — continue it exactly as it arrives for 15-40 m and end it at the shore.
- **60-72%: a watercourse** about 11 m wide — meet it at the seam and let it reach the sea.
- **72-74%: the island's GROUND** — continue it exactly as it arrives for 15-40 m and end it at the shore.
- **74-100%: the island's SEA** — 26 m of open water at the seam. It stays OPEN SEA in this cell: no rock, no beach, no stack across it.

**Your previous candidate missed this edge — measured, not an opinion:**
- from 56% to 58% of the EAST edge it painted WATER where the island's GROUND arrives — that stretch must be land at the seam, continuing the island's.
