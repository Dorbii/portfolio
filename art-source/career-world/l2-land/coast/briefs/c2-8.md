THE SOUTH SHORE beside Tanium's c1-2 (Dark forest gorge).
...
**Your NORTH edge, from its west end, exactly as the island's art delivers it** (70% of it is the island's sea):
- **0-30%: the island's GROUND** — continue it exactly as it arrives for 15-40 m and end it at the shore.
- **30-100%: the island's SEA** — 68 m of open water at the seam. It stays OPEN SEA in this cell: no rock, no beach, no stack across it.
