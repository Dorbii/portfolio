...
**Your NORTH edge, from its west end, exactly as the island's art delivers it** (61% of it is the island's sea):
- **0-41%: the island's SEA** — 40 m of open water at the seam. It stays OPEN SEA in this cell: no rock, no beach, no stack across it.
- **41-80%: the island's GROUND** — continue it exactly as it arrives for 15-40 m and end it at the shore.
- **80-100%: the island's SEA** — 19 m of open water at the seam. It stays OPEN SEA in this cell: no rock, no beach, no stack across it.
