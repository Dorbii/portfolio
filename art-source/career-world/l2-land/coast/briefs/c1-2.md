THE WEST SHORE beside NinjaOne's c0-1 (Settlement shelf).
...
**Your EAST edge, from its north end, exactly as the island's art delivers it** (53% of it is the island's sea):
- **0-47%: the island's GROUND** — continue it exactly as it arrives for 15-40 m and end it at the shore.
- **47-100%: the island's SEA** — 52 m of open water at the seam. It stays OPEN SEA in this cell: no rock, no beach, no stack across it.

**The bay's mouth is open water — hard.** N c0-1's bay arrives across your
...
- from 47% to 99% of the EAST edge it painted LAND where the island's SEA arrives — that stretch must be open water at the seam.
