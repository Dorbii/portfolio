...
paint — its ground (open heather-and-grass moor, wind-scoured, boulders and scrub; heather sparse and subdued, never a carpet) in some
...
**Your NORTH edge, from its west end, exactly as the island's art delivers it** (93% of it is the island's sea):
- **0-89%: the island's SEA** — 87 m of open water at the seam. It stays OPEN SEA in this cell: no rock, no beach, no stack across it.
- **89-96%: the island's GROUND** — continue it exactly as it arrives for 15-40 m and end it at the shore.
- **96-100%: a watercourse** about 4 m wide — meet it at the seam and let it reach the sea.

**A shore, not a plateau — hard.** T c5-2's ground reaches your NORTH edge
...
- from 89% to 95% of the NORTH edge it painted WATER where the island's GROUND arrives — that stretch must be land at the seam, continuing the island's.
