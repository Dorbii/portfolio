THE SOUTH SHORE beside Tanium's c4-2 (Bench country).
...
**Your NORTH edge, from its west end, exactly as the island's art delivers it** (32% of it is the island's sea):
- **0-22%: the island's GROUND** — continue it exactly as it arrives for 15-40 m and end it at the shore.
- **22-30%: a watercourse** about 8 m wide — meet it at the seam and let it reach the sea.
- **30-76%: the island's GROUND** — continue it exactly as it arrives for 15-40 m and end it at the shore.
- **76-100%: the island's SEA** — 23 m of open water at the seam. It stays OPEN SEA in this cell: no rock, no beach, no stack across it.

**Your previous candidate missed this edge — measured, not an opinion:**
- from 26% to 29% of the NORTH edge it painted LAND where the island's SEA arrives — that stretch must be open water at the seam.
- from 76% to 80% of the NORTH edge it painted LAND where the island's SEA arrives — that stretch must be open water at the seam.
