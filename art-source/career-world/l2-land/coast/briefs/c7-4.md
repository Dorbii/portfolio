THE EAST SHORE beside NinjaOne's c4-3 (Construction quarry).
...
**Your WEST edge, from its north end, exactly as the island's art delivers it** (65% of it is the island's sea):
- **0-24%: the island's SEA** — 24 m of open water at the seam. It stays OPEN SEA in this cell: no rock, no beach, no stack across it.
- **24-57%: the island's GROUND** — continue it exactly as it arrives for 15-40 m and end it at the shore.
- **57-59%: a watercourse** about 2 m wide — meet it at the seam and let it reach the sea.
- **59-61%: the island's GROUND** — continue it exactly as it arrives for 15-40 m and end it at the shore.
- **61-100%: the island's SEA** — 38 m of open water at the seam. It stays OPEN SEA in this cell: no rock, no beach, no stack across it.

**Your previous candidate missed this edge — measured, not an opinion:**
- from 0% to 23% of the WEST edge it painted LAND where the island's SEA arrives — that stretch must be open water at the seam.
- from 46% to 50% of the WEST edge it painted WATER where the island's GROUND arrives — that stretch must be land at the seam, continuing the island's.
- from 61% to 87% of the WEST edge it painted LAND where the island's SEA arrives — that stretch must be open water at the seam.
