THE EAST SHORE beside Tanium's c6-2 (Construction quarry).
...
**Your WEST edge, from its north end, exactly as the island's art delivers it** (92% of it is the island's sea):
- **0-57%: the island's SEA** — 56 m of open water at the seam. It stays OPEN SEA in this cell: no rock, no beach, no stack across it.
- **57-65%: the island's GROUND** — continue it exactly as it arrives for 15-40 m and end it at the shore.
- **65-100%: the island's SEA** — 34 m of open water at the seam. It stays OPEN SEA in this cell: no rock, no beach, no stack across it.

**Your previous candidate missed this edge — measured, not an opinion:**
- from 37% to 56% of the WEST edge it painted LAND where the island's SEA arrives — that stretch must be open water at the seam.
- from 65% to 71% of the WEST edge it painted LAND where the island's SEA arrives — that stretch must be open water at the seam.
