...
**Your WEST edge, from its north end, exactly as the island's art delivers it** (55% of it is the island's sea):
- **0-27%: the island's SEA** — 26 m of open water at the seam. It stays OPEN SEA in this cell: no rock, no beach, no stack across it.
- **27-72%: the island's GROUND** — continue it exactly as it arrives for 15-40 m and end it at the shore.
- **72-100%: the island's SEA** — 27 m of open water at the seam. It stays OPEN SEA in this cell: no rock, no beach, no stack across it.

**Your previous candidate missed this edge — measured, not an opinion:**
- from 27% to 36% of the WEST edge it painted WATER where the island's GROUND arrives — that stretch must be land at the seam, continuing the island's.
