...
**Your NORTH edge, from its west end, exactly as the island's art delivers it** (31% of it is the island's sea):
- **0-0%: a watercourse** about 0 m wide — meet it at the seam and let it reach the sea.
- **0-69%: the island's GROUND** — continue it exactly as it arrives for 15-40 m and end it at the shore.
- **69-100%: the island's SEA** — 30 m of open water at the seam. It stays OPEN SEA in this cell: no rock, no beach, no stack across it.
...
- from 51% to 68% of the NORTH edge it painted WATER where the island's GROUND arrives — that stretch must be land at the seam, continuing the island's.
