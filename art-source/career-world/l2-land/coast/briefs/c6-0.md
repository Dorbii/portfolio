THE NORTH SHORE beside NinjaOne's c4-0 (Settlement shelf).
...
**Your SOUTH edge, from its west end, exactly as the island's art delivers it** (2% of it is the island's sea):
- **0-98%: the island's GROUND** — continue it exactly as it arrives for 15-40 m and end it at the shore.
- **98-100%: a watercourse** about 2 m wide — meet it at the seam and let it reach the sea.
