...
**Your EAST edge, from its north end, exactly as the island's art delivers it** (14% of it is the island's sea):
- **0-14%: a watercourse** about 14 m wide — meet it at the seam and let it reach the sea.
- **14-100%: the island's GROUND** — continue it exactly as it arrives for 15-40 m and end it at the shore.
